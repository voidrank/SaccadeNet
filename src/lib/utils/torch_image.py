...
def gaussian_radius(det_size, min_overlap=0.7):
  '''
  :param det_size: width and height of objs with shape of (num_batch, num_obj, 2)
  :param min_overlap:
  :return: guassian radius: (num_batch, num_obj, 1)
  '''
  height, width = det_size[:,:,0:1], det_size[:,:,1:2]
  ...
  r3  = (b3 + sq3) / 2
  return torch.min(torch.cat([r1, r2, r3], 2), 2, keepdim=True)[0]
